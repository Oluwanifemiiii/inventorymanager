 ...
 * @author nifem
 */
public class WebcamPage extends javax.swing.JFrame {
static {
        File file = new File("C:\\Users\\nifem\\Downloads\\JavaCVDriver\\required\\opencv_java249.dll");
    ...
    private void CaptureImage(JLabel image) {
        try {
            ...
            if (getImage != null) {
                ...
                ImageIcon imageico = new ImageIcon(new ImageIcon(Filename).getImage().getScaledInstance(ITAdminHomePage.jLabel7.getWidth(),
                        ITAdminHomePage.jLabel7.getHeight(), Image.SCALE_DEFAULT));
                ITAdminHomePage.jLabel7.setIcon(imageico);
        }
}             catch (Exception e) {
...
int option = JOptionPane.showConfirmDialog(rootPane, "Are you sure you want to capture the image");
        if (option == 0) {
            try {
                ...
                ITAdminHomePage.jTextField11.setText(Filename);
                ...
                ITAdminHomePage.photo = baos.toByteArray();
                dispose();
            } catch (Exception e) {
                stopCam();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WebcamPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WebcamPage().setVisible(true);
            }
        });
    }
